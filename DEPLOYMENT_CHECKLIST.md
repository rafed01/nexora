...
1. Run Supabase migrations in order: `001_production_schema.sql`, `002_production_security.sql`, `003_auth_trigger_repair.sql`, `004_enterprise_employee_approval.sql`, `005_atomic_approval_workflows.sql`, `006_mvp_workflow_security.sql`, then `007_final_production_workflows.sql`.
